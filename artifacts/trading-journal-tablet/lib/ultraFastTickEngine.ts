 ...
 *
 * React Native port of src/lib/ultraFastTickEngine.ts
 * ─────────────────────────────────────────────────────
 * requestAnimationFrame and cancelAnimationFrame are available as globals in
 * React Native's Hermes runtime (the same JS API as the browser).  No
 * substitution is required.  All other constructs (Float64Array, Set, class,
 * Date.now) are identical across platforms.
 */
