/**
 * symbolRegistry.ts — single source of truth for non-crypto (cTrader) symbols.
 *
 ...
 *
 * React Native port of src/lib/symbolRegistry.ts
 * ─────────────────────────────────────────────
 * No modifications — this file contains only pure TypeScript data constants and
 * interface definitions.  There are no DOM APIs, browser globals, or
 * HTML-specific constructs.  Zero changes required for React Native / Hermes.
 */
