/**
 * SubscriptionManager.ts — topic-based pub/sub registry.
 *
 * React Native port of src/lib/broker-ws/SubscriptionManager.ts
 * ─────────────────────────────────────────────────────────────
 * No modifications required.  Pure TypeScript business logic with no
 * browser APIs, DOM types, or browser globals.  Fully compatible with
 * Hermes and React Native.  Logic is preserved exactly.
 */
