/**
 * types.ts — shared broker WebSocket types.
 *
 * React Native port of src/lib/broker-ws/types.ts
 * ─────────────────────────────────────────────────
 * No modifications required.  This file contains only pure TypeScript
 * business-domain types.  There are no DOM APIs, browser globals, or
 * HTML-specific constructs.  All types are fully compatible with Hermes
 * and React Native's type environment.
 */
