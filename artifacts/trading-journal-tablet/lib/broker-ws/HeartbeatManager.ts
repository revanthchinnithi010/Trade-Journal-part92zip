/**
 * HeartbeatManager.ts — periodic ping / pong latency tracker.
 *
 * React Native port of src/lib/broker-ws/HeartbeatManager.ts
 * ───────────────────────────────────────────────────────────
 * No modifications required.  Uses only setInterval / setTimeout /
 * clearInterval / clearTimeout, which are available identically in both
 * the browser and React Native / Hermes.  Logic is preserved exactly.
 */
