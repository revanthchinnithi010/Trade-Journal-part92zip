 ...
 *
 * React Native port of src/lib/realtimeTradeAggregator.ts
 * ────────────────────────────────────────────────────────
 * No modifications — pure computation with no DOM APIs, no browser globals,
 * and no platform-specific dependencies.  Date.UTC / Math.floor / class
 * constructs are identical on Hermes and V8.
 */
