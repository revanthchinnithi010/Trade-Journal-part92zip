/**
 * Mock calendar heatmap data — React Native port of src/mock/data/calendar.ts
 *
 * RN compatibility changes vs the web original
 * ─────────────────────────────────────────────
 * None. Pure TypeScript with standard ECMAScript Date/Map/Array APIs,
 * all fully supported by Hermes.
 */
