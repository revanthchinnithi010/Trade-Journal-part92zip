/**
 * Mock trade history — React Native port of src/mock/data/trades.ts
 *
 * RN compatibility changes vs the web original
 * ─────────────────────────────────────────────
 * None. All logic uses standard ECMAScript Date/Math/Array APIs and the
 * deterministic createRng helper, both fully supported by Hermes.
 */
