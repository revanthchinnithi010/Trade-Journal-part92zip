/**
 * ctraderSpotStore — Zustand store for cTrader live spot data.
 *
 ...
 *
 * React Native port of src/store/ctraderSpotStore.ts
 * ──────────────────────────────────────────────────
 * No modifications — this file contains only a pure Zustand store with no
