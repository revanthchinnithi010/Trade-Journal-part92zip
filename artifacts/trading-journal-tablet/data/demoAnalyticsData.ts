 ...
 *
 * React Native port of src/data/demoAnalyticsData.ts
 *
 * Modifications vs the web original
 * ──────────────────────────────────
 * None. All logic uses standard ECMAScript APIs (Date, Math, Array) that are
 * available in the Hermes JS engine used by React Native. There are no DOM
 * APIs, browser globals, or CSS references.
 *
 * ┌─────────────────────────────────────────────────────────────────────┐
