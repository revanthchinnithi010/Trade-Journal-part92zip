/**
 * Market data routing constants and static lookup tables —
 * React Native port of src/data/sampleData.ts
 *
 * Modifications vs the web original
 * ──────────────────────────────────
 * None. This file contains only pure TypeScript constants and lookup tables.
